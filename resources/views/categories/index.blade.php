<x-app>
    <x-slot name="content">
        ...
        <div class="content-wrapper">
            <x-content-header title="Categories" :urls="['Categories' => route('categories.index')]" />
                            ...
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            @can('create-categories') <a href="{{ route('categories.create') }}" class="btn btn-primary my-2">Create</a> @endcan
                                        </div>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row p-3 border-top border-bottom">
                                            <div class="mb-2 col-12 col-sm">
                                                ...
                                                <a href="{{ route('categories.show', $resource->id) }}"><strong>{{ $resource->name }}</strong></a>
                                            </div>
                                            <div class="mb-2 col-12 col-sm">
                                            ...
                                            <div class="mb-2 col-12 col-sm-2 text-right">
                                                <div class="btn-group" role="group">
                                                    @can('edit-categories')
                                                        <a href="{{ route('categories.edit', $resource->id) }}" class="btn btn-sm btn-light" tooltip data-placement="bottom" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    @endcan
                                                    @can('delete-categories')
                                                        <form action="{{ route('categories.destroy', $resource->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
                                                            @csrf
                                                            @method('DELETE')
