<x-app>
    <x-slot name="content">
        ...
        <div class="content-wrapper">
            <x-content-header title="Users" :urls="['Users' => route('users.index')]" />
                            ...
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            @can('create-users') <a href="{{ route('users.create') }}" class="btn btn-primary my-2">Create</a> @endcan
                                        </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="container-fluid">
                                        <div class="row p-3 border-top border-bottom d-none d-sm-flex">
                                            <div class="col-12 col-sm">User</div>
                                        ...
                                        <div class="row p-3 border-top border-bottom">
                                            ...
                                            <div class="mb-2 col-12 col-sm-2 text-right">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    @endcan
                                                    @can('delete-users')
                                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="text-muted my-2">{{ "Showing {$users->firstItem()}-{$users->lastItem()} of {$users->total()}" }}</div>
                                        </div>
                                        <div class="col-auto ml-auto">
                                            {{ $users->links() }}
                                        </div>
